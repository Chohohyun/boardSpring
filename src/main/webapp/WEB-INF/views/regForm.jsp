...
function goDriverRegForm() {
    ...
    <script src="/erp/resources/vendor2/jquery/jquery.min.js"></script>
    <!-- Vendor JS-->
    <script src="/erp/resources/vendor2/select2/select2.min.js"></script>
    <script src="/erp/resources/vendor2/datepicker/moment.min.js"></script>
    <script src="/erp/resources/vendor2/datepicker/daterangepicker.js"></script>

    <!-- Main JS-->
    <script src="/erp/resources/js2/global.js"></script>
...
<head>
    ...
    <!-- Icons font CSS-->
    <link href="/erp/resources/vendor2/mdi-font/css/material-design-iconic-font.min.css" rel="stylesheet" media="all">
    <link href="/erp/resources/vendor2/font-awesome-4.7/css/font-awesome.min.css" rel="stylesheet" media="all">
    <!-- Font special for pages-->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800,800i" rel="stylesheet">

    <!-- Vendor CSS-->
    <link href="/erp/resources/vendor2/select2/select2.min.css" rel="stylesheet" media="all">
    <link href="/erp/resources/vendor2/datepicker/daterangepicker.css" rel="stylesheet" media="all">

    <!-- Main CSS-->
    <link href="/erp/resources/css/main.css" rel="stylesheet" media="all">
    <link href="/erp/resources/css2/main.css" rel="stylesheet" media="all">
    ...
    <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                ...
                <div class="card-body">
                 <center>
                <button class="btn btn--radius-2 btn--red" name = "userRegFormBtn" onclick="changeToUser();" >일반회원</button>
                <button class="btn btn--radius-2 btn--blue" name = "driverRegFormBtn"  onclick="changeToDriver();" >운전자</button>
                <br>
                <br>
                </center>
                    <form name="userRegForm" method="POST">
                            ...
                            <div class="value">
                                <div class="row row-refine">
                                           ...
                                           <span class="focus-input100"></span>
                                 			  ...
                                 			  &nbsp;&nbsp;&nbsp;
                                        <div class="wrap-input50 input-group-desc">
                        					<button class="btn btn--radius-2 btn--red" onclick="searchPostal_code()" type="button">주소검색</button>
                        ...
                        <div>
                        <center>
                            <button class="btn btn--radius-2 btn--red" onclick="goUserRegForm();">가입</button>
                            <button class="btn btn--radius-2 btn--green" type="button" onclick="goLoginForm();">취소</button>
                            </center>
                        </div>
                    </form>
                    ...
                    <!-- ----------------------------------------------------------------------------------------------- -->
                      ...
                      <form name="driverRegForm" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group wrap-input100">
                                    <input class="input100 input--style-5" type="email" name="pwd1" placeholder="비밀번호">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group wrap-input100">
                                    <input class="input100 input--style-5" type="email" name="pwd2" placeholder="비밀번호 확인">
                            ...
                            <div class="value">
                                <div class="row row-space">
                                    <div class="input-group wrap-input100">
                               			 ...
                               			 <label class="radio-container m-r-55">여
                                   		 <input type="radio" checked="checked" name="gender" value="y">
                                    		<span class="checkmark"></span>
                               			 </label>
                                </div>
                               </div>
                         ...
                         <div class="form-row m-b-55">
                            ...
                            <div class="value">
                                <div class="row row-refine">
                                        ...
                                        <div class="wrap-input40 input-group-desc">
                                            <input class="input100 input--style-5" type="text" name="area_code" placeholder="앞주민번호">
                                           ...
                                           <span class="focus-input100"></span>
                                 			  ...
                                 			  &nbsp;&nbsp;&nbsp;
                                        <div class="wrap-input50 input-group-desc">
                                            <input class="input100 input--style-5" type="text" name="phone" placeholder="뒷주민번호">
                                   ...
                                   <!--  <div class="col-4">
                                        <div class="wrap-input100 input-group-desc">
                                            <input class="input40 input--style-5" type="text" name="jumin_num1">
                                    ...
                                    <div class="col-5">
                                        <div class="wrap-input100 input-group-desc">
                                            <input class="input40 input--style-5" type="text" name="jumin_num2">
                                ...
                                <div class="row row-refine">
                                        ...
                                        <div class="wrap-input50 input-group-desc">
                                         ...
                                         <div class="wrap-input40 input-group-desc">
                       					...
                       					<input class="input100 input--style-5" id="road_addr"  type="text" name="rode_addr" >
                        ...
                        <div>
                        <center>
                            <button class="btn btn--radius-2 btn--red" onclick="goDriverRegForm();">가입</button>
                            <button class="btn btn--radius-2 btn--green" type="button" onclick="goLoginForm();">취소</button>
                            </center>
                        </div>
                    </form>
